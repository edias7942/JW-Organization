...
export default function CartPlaces() {
  ...
  useEffect(() => {
    Axios.post("http://localhost:3001/cart_places").then((response) =>
  ...
  return (
    <div id="cart-place-container">
      <div id="cp-header">Locais para o Carrinho:</div>
          ...
          places.map((element) => {
            return (
              ...
              >
                ...
                <div className="cp-street">
                  {element.STREET}, n° {element.STREET_NUMBER}
                </div>
                <div className="cp-icons">
                  <Link
                    id="google-maps-img-2"
                  ...
                  <div>
                    <img
                      title="Edições Desativadas Temporariamente"
